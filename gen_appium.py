...
def create_workbooks():
    tc_filename = 'appium-tests/Appium_Test_Cases.xlsx'
    sum_filename = 'appium-tests/Appium_Test_Summary.xlsx'
    ...
    wb_sum.close()
    print("Successfully generated appium-tests/Appium_Test_Cases.xlsx and appium-tests/Appium_Test_Summary.xlsx")
