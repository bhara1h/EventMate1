...
import { Mail, User, Phone, MapPin, Building2, Save } from 'lucide-react'
      ...
      <main className="flex-1 px-4 py-8">
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="flex justify-between items-center">
            <h1 className="text-4xl font-bold text-gradient">Organizer Profile</h1>
            <Button
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card className="md:col-span-1 text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">{formData.organization}</p>
              </div>
            </Card>
