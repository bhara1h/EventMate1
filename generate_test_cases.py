...
def create_workbooks():
    tc_filename = 'EventMate_Test_Cases.xlsx'
    sum_filename = 'EventMate_Test_Summary.xlsx'
    ...
    wb_sum.close()
    print("Successfully generated EventMate_Test_Cases.xlsx and EventMate_Test_Summary.xlsx")
